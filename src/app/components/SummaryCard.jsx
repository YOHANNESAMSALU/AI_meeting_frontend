...
export default function SummaryCard({ summary }) {
  ...
  return (
    <div className="glass-panel rounded-[30px] p-6 sm:p-7">
      ...
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <h3 className="mt-1 text-xl font-semibold text-[var(--shell-ink)]">
              Team-ready recap
            </h3>
          </div>
        </div>
      ...
      <div className=" mt-5 rounded-[24px] px-5 py-4 text-sm leading-8 text-[var(--shell-copy)] sm:text-base">
        
        {summary.split("\n").map((line, idx) => (
          <p
            key={idx}
            className="glass-subcard mb-2 last:mb-0 text-black rounded-lg px-3 py-2"
          >
